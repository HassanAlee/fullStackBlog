                ...
                <div className='h-full w-full flex items-center justify-center'>
                    <form className='text-sm w-full sm:w-[60%] px-4 sm:px-0'>
                        ...
                        <div className='flex flex-col mb-4'>
                            ...
                            <input type="text" id='name' name='name' className='rounded-lg py-2 px-3 outline-none border' />
                        </div>
                        <div className='flex flex-col mb-4'>
                        ...
                        <div className='flex flex-col mb-4'>
                            ...
                            <input type="text" id='country' name='country' className='rounded-lg py-2 px-3 outline-none border' />
                        </div>
